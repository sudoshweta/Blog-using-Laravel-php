                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><small>only applicable if company employee</small></p>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="state" type="select" class="form-control @error('state') is-invalid @enderror" name="state" value="{{ old('state') }}" required autocomplete="state" autofocus> -->
                                <select name="state" id = "state">
                                    ...
                                    <option value="Gujarat">Andhra Pradesh</option>
...
<!-- 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <!-- <form>
                                  <input type="checkbox" name="hobbies" class="radio" value="1" value="reading"> Reading<br>
                                  <input type="checkbox" name="hobbies" class="radio" value="1" value="sports">Playing Sports<br>
                                  <input type="checkbox" name="hobbies" class="radio" value="1" value="Dancing" checked> Dancing<br><br>
